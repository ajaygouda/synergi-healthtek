...
export interface ApiContactPageContactPage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    address: Schema.Attribute.Component<'components.address', false>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    logo: Schema.Attribute.Media<'images' | 'files' | 'videos' | 'audios'> &
      Schema.Attribute.Required;
    menus: Schema.Attribute.Component<'components.menu', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePageHomePage extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    experiences: Schema.Attribute.Component<'sections.card', true>;
    ...
    heroSlider: Schema.Attribute.Component<'sections.card', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiJobJob extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    experience: Schema.Attribute.Decimal;
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    totalOpening: Schema.Attribute.Integer;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiNavigationNavigation extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    > &
      Schema.Attribute.Private;
    logoMobile: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    logoWeb: Schema.Attribute.Media<'images'> & Schema.Attribute.Required;
    menus: Schema.Attribute.Component<'components.menu', true>;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiOrderOrder extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    paymentMethod: Schema.Attribute.Enumeration<['cod', 'online', 'upi']>;
    paymentStatus: Schema.Attribute.Enumeration<['unpaid', 'paid', 'refunded']>;
    products: Schema.Attribute.Component<'components.order-item', true>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    ...
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    userId: Schema.Attribute.Relation<'oneToOne', 'api::customer.customer'>;
    username: Schema.Attribute.String &
      Schema.Attribute.Required &
      Schema.Attribute.Unique &
      Schema.Attribute.SetMinMaxLength<{
