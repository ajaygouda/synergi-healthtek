...
export const Address = ({ data }) => {
    ...
    return (
        <>
            <div className="mb-4">
                <div className="h-10 w-10 mb-2 text-secondary-500 flex items-center justify-center rounded-[50px] bg-secondary-200">
                    <svg className="h-6 w-6 fill-current" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M12 2C8.13 2 5 5.13 5 9c0 1.74.5 3.37 1.41 4.84.95 1.54 2.2 2.86 3.16 4.4.47.75.81 1.45 1.17 2.26.26.55.47 1.5 1.26 1.5s1-.95 1.25-1.5c.37-.81.7-1.51 1.17-2.26.96-1.53 2.21-2.85 3.16-4.4C18.5 12.37 19 10.74 19 9c0-3.87-3.13-7-7-7m0 9.75c-1.38 0-2.5-1.12-2.5-2.5s1.12-2.5 2.5-2.5 2.5 1.12 2.5 2.5-1.12 2.5-2.5 2.5"></path></svg>
                </div>
                <div>
            ...
            <div className="mb-4">
                <div className="h-10 w-10 mb-2 text-secondary-500 flex items-center justify-center rounded-[50px] bg-secondary-200">
                    <svg className="h-6 w-6 fill-current" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M20 4H4c-1.1 0-1.99.9-1.99 2L2 18c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2m0 4-8 5-8-5V6l8 5 8-5z" /></svg>
                </div>
                <div>
            ...
            <div>
                <div className="h-10 w-10 mb-2 text-secondary-500 flex items-center justify-center rounded-[50px] bg-secondary-200">
                    <svg className="h-6 w-6 fill-current" focusable="false" aria-hidden="true" viewBox="0 0 24 24"><path d="M20.01 15.38c-1.23 0-2.42-.2-3.53-.56-.35-.12-.74-.03-1.01.24l-1.57 1.97c-2.83-1.35-5.48-3.9-6.89-6.83l1.95-1.66c.27-.28.35-.67.24-1.02-.37-1.11-.56-2.3-.56-3.53 0-.54-.45-.99-.99-.99H4.19C3.65 3 3 3.24 3 3.99 3 13.28 10.73 21 20.01 21c.71 0 .99-.63.99-1.18v-3.45c0-.54-.45-.99-.99-.99" /></svg>
                </div>
                <div>
            ...
            <div className="w-full flex gap-4 mt-10">
                {socials.map((social, index) => (
                    <a className="h-7 w-7 rounded-4xl flex items-center justify-center text-gray-500 transition hover:text-gray-900 dark:text-gray-500" href="" key={index}>
